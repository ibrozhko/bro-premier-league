...
export const season2ResultOverrides: Record<string, { homeScore: number; awayScore: number }> = {
  ...
  "S2-05-02": { homeScore: 8, awayScore: 2 },
  ...
  "S2-08-04": { homeScore: 2, awayScore: 3 },
  "S2-08-05": { homeScore: 5, awayScore: 3 },
  "S2-08-06": { homeScore: 3, awayScore: 3 },
  ...
  "S2-10-01": { homeScore: 7, awayScore: 3 },
  "S2-10-02": { homeScore: 3, awayScore: 7 },
  "S2-10-03": { homeScore: 2, awayScore: 12 },
  "S2-10-04": { homeScore: 5, awayScore: 7 },
...
export const season2LastUpdated = "11.09.2026";
