        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm text-white/70">
              <li>Напрям матчу — 5 балів у групі, 10 у плей-офф</li>
              <li>Точний рахунок — +10 у плей-офф або 10 у групі</li>
...
function FooterLink({ to, icon: Icon, label }: { to: string; icon: typeof Shield; label: string }) {
  return (
    <Link
      to={to}
      className="inline-flex items-center gap-2 rounded-md border border-white/20 bg-[#3441dd] px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:border-[#bbf903] hover:bg-[#3b48df]"
    >
